...
@Component({
  imports: [AgencyProcessTimelineComponent, PageMotionDirective, RouterLink],
  template: `
    <section class="page-hero page-hero--agency">
      ...
      <div class="shell page-hero__content">
        ...
        <h1 appPageMotion="hero" [motionDelay]="330">Non aggiungiamo rumore. Mettiamo a fuoco ciò che conta.</h1>
    ...
    <section class="section">
      <div class="shell two-column two-column--offset">
        <div appPageMotion="rise"><p class="eyebrow">Il nostro punto di vista</p><h2>Estetica e strategia non sono due reparti separati.</h2></div>
    ...
    <section class="section agency-image-block">
      <div class="shell media-split">
        <div appPageMotion="rise" class="media-split__image"><img [src]="config.images.production.src" [srcset]="config.images.production.srcset" [sizes]="config.images.production.sizes" [alt]="config.images.production.alt" loading="lazy" width="1200" height="800" /></div>
        <div appPageMotion="rise" [motionDelay]="180" class="media-split__copy"><p class="eyebrow">Competenze connesse</p><h2>La stessa cura attraversa ogni punto di contatto.</h2><p>Produzione audiovisiva, gestione social, advertising, branding e sviluppo web: scegliamo la combinazione che serve al progetto, non un pacchetto rigido.</p><a class="button" routerLink="/servizi">Esplora i servizi <span aria-hidden="true">→</span></a></div>
      </div>
    </section>
  `,
})
